...
/**
 * Created by inf.gondoloa1112 on 28/10/2019.
 */
...
public class InputOutputUtility {
    ...
    /**
     * legge la data e l'ora per impostare una calendar
     * @param outStr: megssagio per l'utente
     * @param df: pattenr di information per la data
     * @return
     */
